...
public class Hardware {
	...
	private static final Temp[]	specialRegs	= { rsp, rbp, rax, rdx };

	private static final Temp[]	argRegs		= { rdi, rsi, rdx, rcx, r8, r9 };

	private static final Temp[]	calleeSaves	= {rbx, rsp, rbp, r12, r13, r14, r15};

	private static final Temp[]	callerSaves	= {rax, rcx, rdx, rsi, rdi, r8, r9, r10, r11};
