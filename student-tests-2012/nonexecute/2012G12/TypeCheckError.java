// EXT:LONG
// Errors should appear because nums and choices cannot be accesed as arrays in line 19 and 24
...
class Prob {
		...
		if (100 < 100)
			...
			if (nums[0] < 1)
				...
				if (choices < 1)
					...
					aux = (nums/choices[0]) * this.ComputeProb(nums-1, choices-1);
			else{}
	else{}
	return aux;
    }
	...
	public long callTest6(){
		return this.callTest7();
	}
	
	public long callTest7(){
		return 0;
	}
