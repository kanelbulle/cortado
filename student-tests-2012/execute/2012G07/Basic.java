class Basic {
	public static void main(String[] _) {
		...
		int a;
		boolean b;
		res = (new ArrayTest()).main(7);
		res = (new MeanTest()).run();
		a = (new A  (  )  )    .   A(  );
...
class ArrayTest {
	public int main(int i) {
		...
		System.out.println(ifeq.length);
...
class IntegerTest {
	public int run() {
		...
		i = i + 1;
		System.out.println(i);
		System.out.println(3-((7*2)-(2)+(3-10))*5);
		...
		if(true && false){System.out.println(1);}else{System.out.println(2);}
		if(true && true){System.out.println(1);}else{System.out.println(2);}
		if(1 < 1 && (0-1)< 1){System.out.println(1);}else{System.out.println(2);}
		if(1 < 2 && (0-1)< 1){System.out.println(1);}else{System.out.println(2);}
		if(!(1 < 1 && (0-1)< 1)){System.out.println(1);}else{System.out.println(2);}
		if(!(1 < 2 && (0-1)< 1)){System.out.println(1);}else{System.out.println(2);}
		if(true && false && true && false){System.out.println(1);}else{System.out.println(2);}
		if(true && true && true && true){System.out.println(1);}else{System.out.println(2);}
...
class GCD{
	...
	public boolean isNotZero(int a){
		return !(a < 1 && (0-1)< a);
	}
}
...
class Mean {
	...
	public int mean(int numelems, int sum){
		int val;
		int rest;
		val=1;
		while(val*numelems < sum){
			val = val+1;
		}
		return val;
	}

	public int arrayMean(int [] arr){
		int length_;
		int sum;
		int i;
		int val;
		...
		//System.out.println(99999000+ sum);
		return val;
	}
}
